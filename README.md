...
[![Email](https://img.shields.io/badge/Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:connect.ismail.dev@gmail.com)
...
<!-- Profile Summary -->
## 🎯 **Profile Summary**
Passionate Full Stack Software Engineer with **5+ years of experience** in creating end-to-end digital solutions. I specialize in building seamless, scalable, and user-friendly applications using .NET and Angular. I thrive on continuous learning and aim to contribute to meaningful projects that drive innovation and collaboration.
...
### **Software Engineer (.Net)** | Dream71 Bangladesh Ltd.
`January 2025 - Present` | Dhaka, Bangladesh
- Currently contributing to enterprise-level software solutions

### **Software Engineer** | Alchemy Software Limited
`July 2022 - May 2024` | Chattogram, Bangladesh
- Conducted extensive R&D and foreign client project requirement analysis
- Developed internal tools and individual systems used across projects

### **Full Stack Web Developer** | Chandrim Soft
`February 2020 - March 2022` | Chattogram, Bangladesh
- Developed ERP system for renowned industry
- Built government sites and foreign video course streaming platforms
- Completed approximately 10 client projects contributing to business growth
...
### **🏗️ Government & Enterprise Projects**
| Project | Description | Technologies |
|---------|-------------|--------------|
| **RMMS Reports** | Roads & Highway Department of Bangladesh | DevExpress, MSSQL, .NET Core 8, Store Procedures |
| **RMMS Tools** | Export and Analyzer - Reverse Engineering | .NET Core, SQL Server 2022, VB6 Migration |
| **Equipment Inventory Reports** | LGED - LMS System | React, .NET Core 8, pdfMake, SheetJs, MSSQL |
| **Mess Booking & Canteen Management** | CMP System | .NET Framework 4.7.2, MVC, EF, SQL Server |

### **🏢 Commercial ERPs**
| Project | Description | Technologies |
|---------|-------------|--------------|
| **Industrial ERP** | Sheik Tube Mills, Chattogram | .NET Framework 4.7.2, MVC, EF, Ajax, SQL Server |
| **Real Estate ERP** | DRT Holdings Ltd. | .NET Framework 4.7.2, MVC, EF, Ajax, SQL Server |
| **Sauda Kit** | Complete ERP Solution (Personal Project) | .NET Core 8, Angular 16, SQL Server, SQL Lite |

### **🌐 Web Applications**
| Project | Description | Technologies |
|---------|-------------|--------------|
| **Video Streaming Site** | Training Academy in Thailand | .NET Framework 4.7.2, MVC, EF, SQL Server, Omise Payment |
...
### **Education**
- **Diploma in Computer Technology** (CGPA: 3.55/4.00)  
  *Islami Bank Institute of Technology, Chittagong* `2023`

- **M.A. in Islamic Studies**  
  *University of Chittagong* `2022`

- **B.A. (Hons) in Islamic Studies**  
  *University of Chittagong* `2020`

### **Certifications**
- **Web Application Development – Dot.NET** | BITM
- **Complete Web Developer Course** | e-Shikhon.com
- **Microsoft Azure Fundamentals**
- **Computer Office Application** | BTEB `2014`
...
- Agile methodology & CI/CD practices
- Post-production support & troubleshooting
